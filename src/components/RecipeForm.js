...
const RecipeForm = ({onAdd, onEdit}) => {
    ...
    return (
        ...
        <Form.Group className="mb-3" id="recipeForm.name">
            ...
            <Form.Control type="input" value={name} onChange={(e) => setName(e.target.value)} placeholder="e.g. 'Spicy Cocunut Shrimp'" />
        </Form.Group>
        ...
        <Form.Group className="mb-3" id="recipeForm.url">
            ...
            <Form.Control as="input" value={URL} onChange={(e) => setURL(e.target.value)} placeholder="https://recipeurl.com/" />
        </Form.Group>
        <Form.Select className="mb-3" value={category} onChange={(e) => setCategory(e.target.value)} id="recipeForm.category">
        ...
        <Form.Select className="mb-3" value={rating} onChange={(e) => setRating(e.target.value)} id="recipeForm.rating">
